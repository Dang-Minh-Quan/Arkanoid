...
public class Update {
    ...
    private static void updateBullet(MainMedia media, List<Bullet> bullets,
        ...
        for (int i = bullets.size() - 1; i >= 0; i--) {
            ...
            if (b.checkBrickCollision(media, brick, render, powerUps) != 0) {
                bullets.remove(i);
            }
        }
    }
